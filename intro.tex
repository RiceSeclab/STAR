...
web browsers, not traditional polling locations. Our design has a lot
in common with Wombat \cite{wombat}, although it can only support
elections for a single office, rather than the long ballots with which
we must content. Instead, to satisfy our constraints, we must build something new.
