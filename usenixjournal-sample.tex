% usenixjournal-sample.tex 
% This is a sample file for USENIX journals
%
% (Derived from the ACM "small standard" journal format.
%
% Steps to compile: pdflatex, bibtex, pdflatex pdflatex
...
% Figure
\begin{figure}
\centerline{\includegraphics{usenixjournal-mouse}}
...
\bibliography{usenixjournal-sample-bibfile}
